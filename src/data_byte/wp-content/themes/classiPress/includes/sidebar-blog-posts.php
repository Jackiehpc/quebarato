	...
	<?php if(have_posts()) : ?>
		...
		<?php while(have_posts()) : the_post() ?>
			...
			<li>
				...
				<p class="side-meta"><?php _e('by','appthemes') ?> <?php the_author_posts_link(); ?> <?php _e('on','appthemes') ?> <?php echo appthemes_date_posted(get_the_time()); ?> - <?php comments_popup_link(__('0 Comments', 'appthemes'), __('1 Comment', 'appthemes'), __('% Comments', 'appthemes')) ?></p>
