...
function appthemes_load_admin_scripts() {
    ...
    wp_enqueue_script('validate', get_bloginfo('template_directory').'/includes/js/validate/jquery.validate.pack.js', array('jquery-ui-core'), '1.6');
    wp_enqueue_script('admin-scripts', get_bloginfo('template_directory').'/includes/admin/admin-scripts.js', array('jquery'), '1.2');
