                        ...
                        <div class="post">
                            ...
                            <div class="author-main">
								...
								<ul class="author-info">                    
									...
									<li><strong><?php _e('Website:','appthemes'); ?></strong> <a href="<?php echo $curauth->user_url; ?>"><?php echo $curauth->user_url; ?></a></li>
									<li><div class="twitterico"></div><a href="http://twitter.com/<?php echo $curauth->twitter_id; ?>" target="_blank"><?php _e('Twitter','appthemes')?></a></li>
									<li><div class="facebookico"></div><a href="http://facebook.com/<?php echo $curauth->facebook_id; ?>" target="_blank"><?php _e('Facebook','appthemes')?></a></li>
								</ul>
							...
							<ul class="latest">
								...
								<?php query_posts(array('posts_per_page' => 10, 'post_type' => 'ad_listing', 'post_status' => 'publish', 'author' => $curauth->ID)); ?>
