							...
							<h3 class="hndle"><span><?php _e('Admin Email Settings','NewUserEmail'); ?></span></h3>
								<div class="inside">
									...
									<h4><?php _e('Administration Notification Email Address', 'NewUserEmail') ?></h4>
										<input id="newuseremailadminnotify" type="text" size="40" style="font-size: 12px;" value="<?php _e(stripslashes($nue_options['adminnotify']), 'NewUserEmail') ?>" name="newuseremailadminsubject"/>
